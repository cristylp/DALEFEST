...
const PanamaPage = () => {
    return (
        <>
            ...
            <div className="container-panama">
              ...
              <img src={hoja2} alt="" class="hoja-pty2" id="ptyhoja"/>
              <div className="paragraph">
                  <h2 className="titleText" id="panama-title">DAY TRIPS DESDE CIUDAD DE PANAMÁ</h2>
                  <h2 className="subtitle" id="reserva-link">
                    Les recomendamos algunos de nuestros destinos favoritos en Panamá!!! Cualquier pregunta sobre más información y reservas:<br/> Escribenos via <span><a href="mailto: info@viajesgloriamendez.com">email</a></span> o por <span><a href="mailto: info@viajesgloriamendez.com">whatsapp</a></span></h2>

              </div>

              <div className="panama-box" id="first-box">
                <p id="subtitle">VISITA HISTÓRICA A PORTOBELO & FUERTE SAN LORENZO</p>
                <div className="fullWidth" id="panama">
                    <div className="paragraphRight2" id="column-panama">
                        ...
                        <img className="daytripPic" src={Fuerte} alt="Vista aérea del Fuerte de San Lorenzo" id="fuerte-pic"/>
                    </div>

                    <div className="paragraphLeft2" id="column-panama">
              ...
              <div className="panama-box">
                <p id="subtitle">SAN BLAS POR EL DÍA</p>
                <div className="fullWidth sanblas" id="panama">
                    <div className="paragraphRight2 sanblas-column" id="column-panama">
                        <img className="daytripPic" src={Sanblas} alt="Vista aérea de isla en San Blas" id="sanblas-pic"/>
                    </div>
                    <div className="paragraphLeft2" id="column-panama">
              ...
              <div className="panam-box">
                <p id="subtitle">TOUR DE KAYAKS POR EL CANAL DE PANAMÁ</p>
                <div className="fullWidth kayaks" id="panama">
                    <div className="paragraphRight2" id="column-panama-special">
                    ...
                    <div className="paragraphLeft2 sanblas-column" id="column-panama-special2">
                        <img className="daytripPic" src={Canal} alt="Vista aérea del Canal de Panamá" id="canal-pic"/>
                    </div>
                </div>
              </div>

              <div className="panama-box">
                <p id="subtitle">CRUCE PARCIAL DEL CANAL DE PANAMÁ</p>
                <div className="fullWidth canal" id="panama">
                    <div className="paragraphRight2" id="column-panama">
                        ...
                        <img className="daytripPic" src={Canal2} alt="Vista aérea del Canal de Panamá" id="canal-pic2"/>
                    </div>
                    <div className="paragraphLeft2" id="column-panama">
                        ...
                        <img className="daytripPic2" src={Canal3} alt="Vista aérea del Canal de Panamá" id="canal-pic2"/>
                    </div>
                </div>
              </div>

              <div className="panama-box">
                <p id="subtitle">TOUR COMPLETO DE CIUDAD DE PANAMÁ</p>
                <div className="fullWidth tour" id="panama">
                    <div className="paragraphRight2" id="column-panama">
                        ...
                        <img className="daytripPic" src={Casco} alt="Vista aérea del Casco Viejo" id="casco-pic"/>
                        <img className="daytripPic" src={Pty} alt="Vista aérea de noche, Ciudad de Panama" id="casco-pic"/>
                    </div>
                    <div className="paragraphLeft2" id="column-panama">
              ...
              <div className="panama-box">
                <p id="subtitle">SENDERISMO EN CAMINO DE CRUCES</p>
                <div className="fullWidth tour" id="panama">
                    <div className="paragraphRight2 senderismo-column" id="column-panama-special3">
                        ...
                        <img className="daytripPic" src={Hike} alt="Vista de senderismo dentro del parque Camino de Cruces" id="camino-pic"/>
                    </div>
                    <div className="paragraphLeft2" id="column-panama">
              ...
              <div className="panama-box">
                <p id="subtitle">VISITA A PARQUE NATURAL METROPOLITANO, CERRO ANCÓN Y PUNTA CULEBRA</p>
                <div className="fullWidth" id="panama">
                    <div className="paragraphRight2 ancon-column" id="column-panama">
                        ...
                        <img className="daytripPic" src={Flag} alt="Vista del Cerro Ancon" id="ancon-pic"/>
                    </div>
                    <div className="paragraphLeft2" id="column-panama">
                ...
                <div className="panama-box">
                <p id="subtitle">DÍA COMPLETO EN EL VALLE DE ANTÓN</p>
                <div className="fullWidth valle" id="panama">
                    <div className="paragraphRight2 valle-column" id="column-panama">
                        ...
                        <img className="daytripPic" src={Valle} alt="Vista aérea de Montaña"  id="valle-pic"/>
                    </div>
                    <div className="paragraphLeft2" id="column-panama-special">
                ...
                <div className="fullWidth list-recom" id="panama-special3">
                  <div className="paragraphRight2 gamboa" id="column-panama-special4">
                  ...
                  <div className="paragraphLeft2 recom" id="column-panama-special4">
                ...
                <div className="fullWidth" id="panama-special2">
                    <div className="paragraphRight4" id="weekend-trip">
                    ...
                    <div className="paragraphCenter" id="weekend-trip">
                    ...
                    <div className="paragraphLeft4" id="weekend-trip">
                        <img className="LocationPic" src={Venao} alt="Hotel Selina, Playa Venao" />
                        <h2 className="locationText3">PEDASÍ / PLAYA VENAO</h2>
                        <ul className="LocationInfoRight">
                            <li id="li-pedasi">Selina Playa Venao</li>
                            <li id="li-pedasi">Villa Marina Lodge</li>
                            <li id="li-pedasi">Playa Venao Hotel Resort</li>
                            <li id="li-pedasi">El Sitio Hotel</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="LastfullWidth">
                    <div className="paragraphRight2" id="restaurante-column">
                        <h2 className="locationText4">CASUALES</h2>
                        <ul>
                          <li className="basicInfo" id="rest-izq">
                            Tacos la Neta (comida mexicana)
                          </li>
                          <li className="basicInfo" id="rest-izq">
                    ...
                    <div className="paragraphLeft2" id="restaurante-column">
                        <h2 className="locationText5">MÁS UPSCALE</h2>
                        <ul>
                          <li className="basicInfo" id="rest-der">
